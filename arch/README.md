# Passthrough Helper 2021 for Arch/Manjaro 

Passthrough helper for Arch/Manjaro simplifies installing required packages and sets up your PC to run virtual machines with GPU passthrough. <br/>
